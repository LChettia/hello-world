...
df_intake = pd.read_csv("intake_data.csv", parse_dates=["intake_date"], index_col="intake_date")
print(df_intake)

df_output = pd.read_csv("output_data.csv", parse_dates=["output_date"], index_col="output_date")
print(df_output)


#intake details
intake = {'09/12/2019': 95000, '09/13/2019': 9800, '09/14/2019': 9700}
